...
def Love():
    ...
    love.title("我也是呀♪(＾∀＾●)ﾉ")
    label = Label(love,text = "我也是呀♪(＾∀＾●)ﾉ",font = ("微软雅黑",20))
    label.pack()
...
def noLove():
    ...
    no_love.geometry("500x100+520+260")
    no_love.title("不算哦")
    label = Label(no_love,text="重新选择好不好嘛(┬＿┬)",font=("微软雅黑",25))
    label.pack()
...
# 标签控件
label = Label(window,text="小姐姐",font=("微软雅黑",15),fg='red')
# 定位   网格式布局   pack也可以
...
btn1 = Button(window,text="不喜欢",command=noLove,activeforeground="red")
